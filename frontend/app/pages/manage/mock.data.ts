...
export const mockEvents: Event[] = [
...

  {
    ...
    layout: '{"floors":[{"floor_name":"Main Area","floor_order":1,"global_seat_size":16,"stage":{"x1":-0.35,"y1":-0.96,"x2":0.35,"y2":-0.76},"stage_shapes":[],"zones":[{"zone_id":"z10-1","zone_name":"VVIP Intimate","zone_type":"sitting","accessible":true,"shape_type":"rect","color":"#f59e0b","rotation":0,"corner1":{"x":-0.45,"y":-0.74},"corner2":{"x":0.45,"y":-0.74},"corner3":{"x":0.45,"y":-0.18},"corner4":{"x":-0.45,"y":-0.18},"seats":[{"seat_id":"A1","status":"AVAILABLE"},{"seat_id":"A2","status":"AVAILABLE"},{"seat_id":"A3","status":"AVAILABLE"},{"seat_id":"A4","status":"AVAILABLE"},{"seat_id":"B1","status":"AVAILABLE"},{"seat_id":"B2","status":"BOOKED"},{"seat_id":"B3","status":"AVAILABLE"},{"seat_id":"B4","status":"AVAILABLE"},{"seat_id":"C1","status":"AVAILABLE"},{"seat_id":"C2","status":"AVAILABLE"},{"seat_id":"C3","status":"AVAILABLE"},{"seat_id":"C4","status":"AVAILABLE"}]},{"zone_id":"z10-2","zone_name":"Seated Standard","zone_type":"sitting","accessible":true,"shape_type":"rect","color":"#6366f1","rotation":0,"corner1":{"x":-0.85,"y":-0.16},"corner2":{"x":0.85,"y":-0.16},"corner3":{"x":0.85,"y":0.72},"corner4":{"x":-0.85,"y":0.72},"seats":[]}]}]}',
    sessions: [
      {
