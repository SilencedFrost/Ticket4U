...
<template>
    <div class="form-width">
        ...
        <form novalidate>
            <div class="mb-2">
                <label for="email" class="form-label text-reactive-primary user-select-none">{{ $t('common.email') }}:</label>
            ...
            <div class="mb-2">
                <label for="password" class="form-label text-reactive-primary user-select-none">{{ $t('auth.password') }}:</label>
                <div class="input-group">
                    <input id="password" v-model="formData.password" :type="isViewingPassword ? 'text' : 'password'" :class="[
                        'form-control',
                        'bg-reactive-primary',
                        'text-reactive-primary',
                        { 'is-invalid': error.password },
                    ]" />
                    <button class="btn btn-outline-secondary bg-reactive-primary" type="button" @mousedown.prevent="togglePassword">
            ...
            <div class="form-check mb-2">
                <input id="rememberMe" v-model="formData.rememberMe" type="checkbox" class="form-check-input" />
            ...
            <div class="d-flex flex-column">
                <button id="submit-btn" class="btn btn-primary text-center mb-2" :disabled="loading" @click.prevent.stop="login()">
        ...
        <div class="text-center form-text">
            <NuxtLink :to="localePath('/auth/register')" class="text-decoration-none text-reactive-secondary">{{
