...
<template>
  <div class="h-auto bg-reactive-primary overflow-x-hidden mw-100" >
    ...
    <div class="row m-0 container-xxl mx-auto flex-column flex-lg-row">
        <div class="col-lg-9">
            <EventSchedule :eventData="eventData" :eventThumbImage="imgEventThumb" />
            <EventAbout :eventData="eventData" :aboutImage="imgAbout" />
            <EventTickets 
              :eventData="eventData" 
              :eventSchedule="eventSchedule" 
              :heroImage="imgTest2"/>
            <EventOrganizer :eventData="eventData" :organizerImage="imgOrganizerLogo" />
        </div>
        <EventAds :sideBarImage="imgSidebar" />
    </div>
    <EventRelated :eventData="eventData" />
  </div>
</template>