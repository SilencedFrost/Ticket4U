-- Drops
DROP TABLE IF EXISTS public.payment_webhook_event;
...
ALTER TABLE IF EXISTS public.ticket OWNER to postgres;
...
ALTER TABLE IF EXISTS public.payment_webhook_event OWNER to postgres;