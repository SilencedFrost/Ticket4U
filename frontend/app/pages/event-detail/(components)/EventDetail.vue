...
const imgEvent1 =
    'https://images.tkbcdn.com/2/608/332/ts/ds/c5/98/c8/c05ab41ca42f7c41bb7fc720518259db.jpg';
const imgEvent2 =
    'https://images.tkbcdn.com/2/608/332/ts/ds/9d/63/2b/8e002e32d1e883c3615ca708c0293c58.jpg';
const imgEvent3 =
    'https://images.tkbcdn.com/2/608/332/ts/ds/c7/b9/71/7c6753138a01713f966081ac0ac8483b.jpg';
const imgEvent4 =
    'https://images.tkbcdn.com/2/608/332/ts/ds/c2/4d/12/585693b771d27f331cd28960e091a579.jpg';
const imgSidebar =
    ...
    relatedEvents: [
        {
            id: 1,
            image: imgEvent1,
            title: 'Nhà Hát Kịch IDECAF: Tám Cám Đại Chiến',
            date: '2026-01-03',
            price: '270.000',
        },
...
<template>
    <div class="h-auto overflow-x-hidden mw-100">
        <event-hero :title="eventData.title" :date="eventData.date" :time="eventData.time" :venue="eventData.venue" :address="eventData.address" :min-price="eventData.minPrice" :hero-image="eventData.images.hero" />
        <event-nav />
        <div class="row m-0 container-xxl mx-auto flex-column flex-lg-row">
            <div class="col-lg-9">
                <event-schedule :title="eventData.title" :address="eventData.address" :date="eventData.date" :time="eventData.time" :event-thumb-image="eventData.images.location" />
