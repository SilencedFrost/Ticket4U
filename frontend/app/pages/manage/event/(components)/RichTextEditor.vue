...
<template>
  <div class="rich-editor" :class="{ 'is-focused': isFocused, 'is-disabled': disabled }">
    ...
    <div v-if="showLinkModal" class="editor-modal-backdrop" @click.self="showLinkModal = false">
      <div class="editor-modal bg-reactive-primary p-4 rounded-3 shadow-lg">
        ...
        <input
          ...
          v-model="linkUrl"
          type="url"
          class="form-control bg-reactive-secondary border-0 text-reactive-primary mb-3"
          placeholder="https://..."
    ...
    <div v-if="showImageModal" class="editor-modal-backdrop" @click.self="showImageModal = false">
      <div class="editor-modal bg-reactive-primary p-4 rounded-3 shadow-lg">
        ...
        <!-- Preview -->
        <div v-if="imageUrl.trim()" class="image-preview-box mb-3 rounded overflow-hidden bg-reactive-secondary d-flex align-items-center justify-content-center">
...
.rich-editor {
  ...
  background: var(--bg-reactive-secondary, var(--bs-body-bg));
