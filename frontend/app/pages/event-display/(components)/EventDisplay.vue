        ...
        <div class="container-xxl py-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 gap-md-3 ms-auto">
                    <DateRangeFilter :show="showDateFilter" :start-date="startDate" :end-date="endDate" :selected-preset="selectedPreset" :date-range-label="formatDateRange()" :presets="datePresets" :is-mobile="isMobile" @toggle="toggleDateFilter" @select-preset="selectPreset" @update:start-date="startDate = $event" @update:end-date="endDate = $event" @reset="resetDateFilter" @apply="applyDateFilter" />

                    <MainFilter :show="showMainFilter" :selected-location="selectedLocation" :is-free-event="isFreeEvent" :selected-categories="selectedCategories" :locations="locations" :categories="categories" :is-mobile="isMobile" :popup-style="mainFilterPopupStyle" @toggle="toggleMainFilter" @update:selected-location="selectedLocation = $event" @update:is-free-event="isFreeEvent = $event" @toggle-category="toggleCategory" @reset="resetMainFilter" @apply="applyMainFilter" />
                </div>
            </div>
